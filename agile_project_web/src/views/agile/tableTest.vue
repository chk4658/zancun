<template>
  <div class="table-container project-temple"
    ...
    <div v-infinite-scroll="loadMore"
      ...
      <div v-for="item in copyPM" :key="item.id" style="margin-top: 35px">
              ...
              <el-popover
                ...
                <div ref="fan">
                  ...
                  <el-popover
                    ...
                    <div>
                      <div
                        v-if="scope.row.isRequirement===1&&scope.row.taskDeliveryList.filter(i=>i.auditStatus===0||(i.auditStatus===2&&i.isReupload!==1)).length>0">
                        还有交付物需要审核哦
        ...
        <!--      <div :style="{width: milestonesWidth}" v-show="item.collapsed">-->
        <!--        <div class="milestone"-->
...
<script>
  ...
  async function setBatchUdateEstEndTime(_data) {
    ...
    if (vals.length > 0) {
      await _batchUpdateTaskTime(vals);
    }
  ...
  async function batchUpdateEstEndTime() {
    ...
    this.checkeds = [];
    const result = await _batchUpdateTaskTime(vals)
  ...
  export default {
    ...
    created() {
      ...
      // console.log(this.$refs.mainHeight)
